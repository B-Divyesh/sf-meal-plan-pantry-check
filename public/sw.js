const VERSION = 'pantry-ledger-v5';
const SHELL = `${VERSION}-shell`;
const RUNTIME = `${VERSION}-runtime`;
const CORE = ['/', '/offline.html', '/legal.css', '/manifest.webmanifest', '/icons/icon.svg', '/icons/icon-192.png', '/icons/icon-512.png', '/assets/pantry-ledger-960.avif', '/assets/pantry-ledger-960.webp'];
